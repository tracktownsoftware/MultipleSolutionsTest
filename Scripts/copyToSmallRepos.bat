...
:COPYTOSMALLREPOS
	...
	XCOPY MultipleSolutionsTest\WebAppSolution.sln MultipleSolutionsTest_Web /C /Y
	...
	XCOPY MultipleSolutionsTest\WPFAppSolution.sln MultipleSolutionsTest_Windows /C /Y
:END
	echo "finished"
	pause